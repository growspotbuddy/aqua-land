  ...
  return (
    <div style={{
      ...
      <div style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', display: 'flex' }}>
        <button style={tabStyle(activeTab === 'szallas')} onClick={() => setActiveTab('szallas')}>
        ...
        <button style={tabStyle(activeTab === 'jegy')} onClick={() => setActiveTab('jegy')}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {activeSubTab === 'napi' && (
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: '16px', flexWrap: 'wrap' }}>
                ...
                <div>
                  ...
                  <div style={{ ...fieldStyle, minWidth: 'auto', gap: '10px' }}>
            ...
            {activeSubTab === 'berlet' && (
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: '16px', flexWrap: 'wrap' }}>
                ...
                <div>
                  ...
                  <div style={{ ...fieldStyle, minWidth: '200px', cursor: 'pointer' }}>
                    10 napos bérlet
